...
const WG ={
    ...
    createWordsMapByLetterPositionsValues:function (wordList){
        return new Promise((resolve)=>{
            ...
            resolve(wordsMap.sort((a,b)=>{return b.value-a.value}));
        })
    },
    ...
    isStopConditionExist:function(){
        ...
        let lastRowsEval = this.getBoardState().evalList.slice(-1);
        if(lastRowsEval.every(eval=>eval==='correct')){
            console.log('Last row is fully correct. You did it!');
            return true;
        }
    },
       ...
       // console.log(`Query: ${JSON.stringify(query)}`);
        switch (query.status){
            ...
            case 'absent':
                ...
                break
            default:
                this.printToConsole({type:'plainMessageFromPopup',payload:{message:'Unknown status of query'}})
        }
        //console.log(`Filtered wordList: ${wordList}`);
        return wordList;
    },
    ...
    printToConsole:function(messageObject){
        if(messageObject.type === 'plainMessageFromPopup'){
