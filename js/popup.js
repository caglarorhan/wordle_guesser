const WG ={
    ...
    noteIt:function (text){
        ...
        setTimeout(()=>{
            document.querySelector(`#${this.notesItemId}`).innerHTML='';
        },2000)
    },
    ...
    sendNewWord:function (word=''){
        ...
        document.getElementById('guessedWord').value=word;
    ...
    beginToGuess: async function(){
        let guessedWord = document.getElementById('guessedWord');
        if(WG.upperCaseWords.includes(guessedWord.value)){
            await WG.sendNewWord(guessedWord.value);
            WG.noteIt('Started guess');
        }else{
            guessedWord.setSelectionRange(0, WG.wordLength-1);
            WG.noteIt('This word is not in the word list.');
        }
    }
}
